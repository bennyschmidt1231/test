...
public class GuiUndoRedoTest extends ApplicationTest {
    ...
    public void testUndoTextField() {
        ...
        write("test");
        clickOn("#file");clickOn("#undoMenu");
        clickOn("#file");clickOn("#undoMenu");
        verifyThat("#editGivenNames", hasText("te"));
        clickOn("#file");clickOn("#redoMenu");
        clickOn("#file");clickOn("#redoMenu");
    ...
    public void checkMedicationRemoveUndoRedo() {
        ...
        sleep(1, SECONDS);
        clickOn("#addMedication");
        ListView editCurrentMedications = (ListView) targetWindow().getScene().lookup("#editCurrentMedications");
        sleep(1, SECONDS);
        assertTrue(editCurrentMedications.getItems().contains("Aspirin"));
    ...
    public void checkMedicationMoveUndoRedo() {
        ...
        sleep(1, SECONDS);
        ListView editCurrentMedications = (ListView) stage.getScene().lookup("#editCurrentMedications");
        ListView editPreviousMedications = (ListView) stage.getScene().lookup("#editPreviousMedications");
        assertTrue(editCurrentMedications.getItems().contains("Aspirin"));
        clickOn("#editCurrentMedications").clickOn("Aspirin");
    ...
    public void createUserUndoRedo(){
        ...
        write("10/10/2000");
        press(KeyCode.ENTER);
        DatePicker dateOfBirthDatePicker = (DatePicker) stage.getScene().lookup("#dateOfBirthDatePicker");
        ...
        assertEquals(dateOfBirthDatePicker.valueProperty().getValue(), Year.of(2000).atMonth(10).atDay(10));
        clickOn("#lastNameTextField");
        write("test");
        clickOn("#givenNameTextField");
        write("test");
        press(KeyCode.CONTROL, KeyCode.Z); //User can undo and redo using control z and control y when in textfields
        clickOn("#givenNameTextField");
        clickOn("#file"); clickOn("#undoMenu");
        clickOn("#file"); clickOn("#undoMenu");
        clickOn("#file"); clickOn("#undoMenu");
    ...
    public void createClinicianUndoRedo(){
        ...
        TextField streetAddressTextField = (TextField) stage.getScene().lookup("#streetAddressTextField");
        ...
        write("1");
        clickOn("#file"); clickOn("#redoMenu"); // Check nothing unexpected happens
    ...
    public void editClinicianUndoRedo(){
        ...
        clickOn("#file"); clickOn("#undoMenu");
        ComboBox regionComboBox = (ComboBox) stage.getScene().lookup("#regionComboBox");
        TextField clinicianProfileNameText = (TextField) stage.getScene().lookup("#clinicianProfileNameText");
        assertEquals(regionComboBox.valueProperty().getValue(), "Taranaki");
        clickOn("#clinicianProfileNameText");
        press(KeyCode.CONTROL, KeyCode.A);
        write("2");
        clickOn("#file"); clickOn("#redoMenu"); //Nothing should happen
        assertEquals(regionComboBox.valueProperty().getValue(), "Taranaki");
