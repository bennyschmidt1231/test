...
public class AccountManagerTest {
    ...
    public void setUp() {
        ...
        userAttCol = new UserAttributeCollection(2.0, 51.0, "AB-", "1 Fleet Street",
                "", "cashmere", "christchurch", 5678, "NZ", false, "",
        false, 2.0, "None");
        ...
        accMan.getMasterList().add(donorReceiver1);
        accMan.getMasterList().add(donorReceiver2);
        accMan.getMasterList().add(donorReceiver3);
        accMan.getMasterList().add(donorReceiver4);
    ...
    public void issueCommandTest1() {
        accMan.issueCommand(admin, "update", "ABC1234", "attributes", "town", "Springfield");
        assertEquals("Springfield", accMan.getDonorReceivers().get(0).getUserAttributeCollection().getTown());
    }
    ...
    public void issueCommandTest2() {
        accMan.issueCommand(admin, "update", "ABC1234", "organ", "town", "Springfield");
        assertNotEquals("Springfield", accMan.getDonorReceivers().get(0).getUserAttributeCollection().getTown());
    }
    ...
    public void issueCommandTest3() {
        accMan.issueCommand(admin, "update", "XYZ1234", "attribute", "town", "Springfield");
        assertNotEquals("Springfield", accMan.getDonorReceivers().get(0).getUserAttributeCollection().getTown());
    }
    ...
    public void issueCommandTest5() {
        accMan.issueCommand(admin, "update", "ABC1234", "attribute", "town", "Springfield 123");
        assertNotEquals("Springfield 123", accMan.getDonorReceivers().get(0).getUserAttributeCollection().getTown());;
    }
    ...
    public void issueCommandTest6() {
        accMan.issueCommand(admin, "view", "ABC1234", "attribute", "town", "Springfield 123");
        assertNotEquals("Springfield", accMan.getDonorReceivers().get(0).getUserAttributeCollection().getTown());
    }
    ...
    public void issueCommandTest11() {
        ...
        ArrayList<Clinician> clinciansList = accMan.getClinicians();
    ...
    public void reactivateOldAccountIfExistsTest1() {
        DonorReceiver donorReceiver = accMan.reactivateOldAccountIfExists(admin, accMan.getDonorReceivers().get(0));
    ...
    public void reactivateOldAccountIfExistsTest2() {
        DonorReceiver donorReceiver = accMan.getDonorReceivers().get(0);
    ...
    public void addClinicianIfNoneExistsTest3() {
        AccountManager am = new AccountManager();
        am.getClinicians().add(new Clinician("tim", "", "mckenzie",new ContactDetails(
