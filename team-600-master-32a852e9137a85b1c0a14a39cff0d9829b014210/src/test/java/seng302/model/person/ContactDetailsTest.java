...
public class ContactDetailsTest {
    ...
    public void testUpdateContactAddress1Invalid() {
        ...
        assertEquals("ERROR: Invalid value @@@@. Street address line 1 must be between 1 and 100 alphanumeric " +
    ...
    public void testUpdateContactsAddressLine2Invalid() {
        ...
        assertEquals("ERROR: Invalid value @@@@. Street address line 2 must be between 0 and 100 alphanumeric " +
                "characters. Spaces, commas, apostrophes, and dashes are also allowed.\n", result[0]);
        assertEquals("Erskine Building", contacts.getAddress().getStreetAddressLn2());
    }
    ...
    public void setNewAddress() {
        Address newAddress = new Address("line 1", "line 2", "suburb", "city", "region", "postcode", "country");
