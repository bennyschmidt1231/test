...
public class ClinicianTest {
    ...
    public void makeLogTest3() {
        ...
        logEntry1 = logEntry1.substring(0, logEntry1.length() - 3);
        logEntry2 = logEntry2.substring(0, logEntry2.length() - 3);
    ...
    public void updateTest1() {
        String expected = "\tregion changed from 'Auckland' to 'Canterbury'. Change made at: " + DonorReceiver.formatDateTimeToString(LocalDateTime.now()) + "\n";
