...
public class MedicationServiceTest {
    ...
    /**
     * Test an invalid query containing special characters gives the expected result, that is
     * it returns an MedicationAutoCompleteResult with the given query and zero suggestions.
     */
    @Test
     ...
     * after 10 seconds and it returns a MedicationAutoCompleteResult with the blank query and zero suggestions.
     */
    @Test
     ...
     * "Reserpine", "Reserpine, hydralazine hydrochloride and hydrochlorothiazide" and
    ...
    public void normalQueryTest() throws IOException {
        try {
            ...
            assertTrue(medicationAutoCompleteResult.getSuggestions().contains("Reserpine, hydralazine hydrochloride and hydrochlorothiazide"));
            assertTrue(medicationAutoCompleteResult.getSuggestions().contains("Reserpine and hydroflumethiazide"));
        } catch (com.fasterxml.jackson.core.JsonParseException jsonParseException) {
            System.out.println("No internet access");
        }
