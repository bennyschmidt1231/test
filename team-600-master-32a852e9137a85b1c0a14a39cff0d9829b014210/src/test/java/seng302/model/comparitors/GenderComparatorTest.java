...
public class GenderComparatorTest {
    ...
    public void setup() {
        ...
        donorReceiverA = new DonorReceiver("Francis", "Henry Dillon", "Ward", LocalDate.of(1851,3,13), "PNZ0017");
        donorReceiverA.setGender('M');

        donorReceiverB = new DonorReceiver("Jennifer", "Mary", "Shipley", LocalDate.of(1952, 2,4), "PNZ0036");
        ...
        donorReceiverD = new DonorReceiver("Sidney", "George", "Holland", LocalDate.of(1893, 10,18), "PNZ0025");
    ...
    /**
     * Attempts to sort a list where every element is in the incorrect position
     * by gender. The correct order is donorReceiverB, donorReceiverA, donorReceiverD, donorReceiverC.
     */
    @Test
    ...
    /**
     * Attempts to sort a list of accounts which is already in the correct
     * order by gender. The order should not change.
     */
    @Test
