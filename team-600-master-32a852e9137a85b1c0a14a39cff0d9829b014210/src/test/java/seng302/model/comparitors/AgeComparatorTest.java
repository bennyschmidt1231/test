...
public class AgeComparatorTest {
    ...
    public void setup() {
        ...
        donorReceiverB = new DonorReceiver("Edward", "'Clone'", "Stafford", LocalDate.of(1819, 4, 23), "PNX0003");
        donorReceiverC = new DonorReceiver("Edward", "", "Stafford", LocalDate.of(1819, 4, 23), "PNZ0003");
    ...
    /**
     * Attempts to sort a list by age where two elements are in the incorrect
     * position. The correct order is either donorReceiverB, donorReceiverC, donorReceiverA OR
     * donorReceiverC, donorReceiverB, donorReceiverA (as B and C are of equal age).
     */
    @Test
    ...
    /**
     * Attempts to sort a list of accounts which is already in the correct order
     * by age. The order of the list should not change.
     */
    @Test
