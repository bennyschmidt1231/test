...
public class AdministratorNameComparator implements Comparator<Administrator> {
    ...
    public int compare(Administrator administratorA, Administrator administratorB) {
        ...
        String accountAName = (administratorA.getFirstName() + administratorA.getMiddleName()
                + administratorA.getLastName()).replaceAll("\\s"," ").toLowerCase();
        String accountBName = (administratorB.getFirstName() + administratorB.getMiddleName()
                + administratorB.getLastName()).replaceAll("\\s"," ").toLowerCase();
