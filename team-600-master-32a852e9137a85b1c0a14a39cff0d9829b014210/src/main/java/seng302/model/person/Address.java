...
public class Address {
    ...
    /**
     * Constructor for the Address class, creates a new instance of the Address class with the necessary information with JSON.
     *
     ...
     * @param postCode         The postcode of the address. If the postcode is invalid, then the postcode is set to be an empty string.
    ...
    public Address(@JsonProperty("streetAddressLn1") String streetAddressLn1,
        ...
        setStreetAddressLn1(streetAddressLn1);
        setStreetAddressLn2(streetAddressLn2);
    ...
    /**
     * Sets line 1 of the street address. If the line given is null, then the line will be stored as an empty string instead.
     *
    ...
    /**
     * Sets line 2 of the street address. If the line given is null, then the line will be stored as an empty string instead.
     *
    ...
    /**
     * Sets the suburb name of the address. If the suburb name given is null, then the suburb name will be stored as an empty string instead.
     *
    ...
    /**
     * Sets the city name of the address. If the city name given is null, then the city name will be stored as an empty string instead.
     *
    ...
    /**
     * Sets the post code of the address. If the post code has no characters, then
     * the post code will be stored as an empty string instead. If the post code is invalid, then the post code will not
     * be changed. If the post code is valid (by the definition of {@link Address#postCodeIsValid}) then
     * that is the post code the address will be set to have.
     *
    ...
    public String updatePostCode(String postCode) {
        String message = "ERROR: Invalid value " + postCode + ". Post code must be a 4 digit integer.\n";
    ...
    /**
     * Validates a (non-empty) post code. The post code must be 4 characters long and contain only numbers in order to
     * be considered valid.
     *
    ...
    public String updateStreetAddressLine1(String value) {
        String message = "ERROR: Invalid value " + value + ". Street address line 1 must be between 1 and 100 alphanumeric " +
                "characters. Spaces, commas, apostrophes, and dashes are also allowed.\n";
        if (validateAlphanumericString(true, value, 1, 100)) {

            if (streetAddressLn1 != null || streetAddressLn1 != "") {
                message = DonorReceiver.createLog("addressStreet", streetAddressLn1, value);
            } else {
                message = DonorReceiver.createLog("addressStreet", "unspecified", value);
            }
    ...
    public String updateStreetAddressLine2(String value) {
        String message = "ERROR: Invalid value " + value + ". Street address line 2 must be between 0 and 100 alphanumeric " +
                "characters. Spaces, commas, apostrophes, and dashes are also allowed.\n";
        if (validateAlphanumericString(true, value, 0, 100)) {

            if (streetAddressLn2 != null) {
                message = DonorReceiver.createLog("addressStreet", streetAddressLn2, value);
            } else {
                message = DonorReceiver.createLog("addressStreet", "unspecified", value);
            }
    ...
    public String updateCityName(String value) {
        String message = "ERROR: Invalid value " + value + ". City name must have at most 100 alphabetical " +
                "characters. Spaces, commas, apostrophes, and dashes are also allowed.\n";
        if (validateAlphanumericString(true, value, 0, 100)) {

            if (cityName != null) {
                message = DonorReceiver.createLog("addressCity", cityName, value);
            } else {
                message = DonorReceiver.createLog("addressCity", "unspecified", value);
            }
            setCityName(value);
        }
        return message;
    ...
    public String updateRegion(String value) {
        String message = "ERROR: Invalid value " + value + ". Region must have at most 100 alphabetical " +
                "characters. Spaces, commas, apostrophes, and dashes are also allowed.\n";
        if (validateAlphanumericString(true, value, 0, 100)) {

            if (region != null) {
                message = DonorReceiver.createLog("addressRegion", region, value);
            } else {
                message = DonorReceiver.createLog("addressRegion", "unspecified", value);
            }
            setRegion(value);
        }
        return message;
    ...
    public String updateSuburb(String value) {
        ...
        if (validateAlphanumericString(true, value, 0, 100)) {
            ...
            if (suburbName != null) {
                message = DonorReceiver.createLog("addressSuburb", region, value);
            } else {
                message = DonorReceiver.createLog("addressSuburb", "unspecified", value);
            }
            setSuburbName(value);
        }
        return message;
    ...
    public String updateCountryCode(String value) {
        String message = "ERROR: Invalid value " + value + ". Country Code must have at most 100 alphabetical " +
                "characters. Spaces, commas, apostrophes, and dashes are also allowed.\n";
        if (validateAlphanumericString(true, value, 0, 100)) {

            if (countryCode != null) {
                message = DonorReceiver.createLog("addressCountryCode", region, value);
            } else {
                message = DonorReceiver.createLog("addressCountryCode", "unspecified", value);
            }
    ...
    /**
     * Validates a string that is provided. Validation is whether or not the string is alphanumeric and within the given length bounds
     *
