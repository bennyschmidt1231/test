...
public class Administrator extends User {
     ...
     * @param modifications An array of strings which log the modifications made to the admin's attributes.
     */
    @JsonCreator
    public Administrator(
        ...
        super(firstName, middleName, lastName, contactDetails, userName, password,  creationDate, modifications);
    }
     ...
     * @param password The password of the administrator. (a string)
     */
    public Administrator(String firstName, String middleName, String lastName, String userName, String password) {
