...
public class ViewProfilePaneController {
   ...
   private ObservableList<Illness> historicDiagnoses;
    ...
    public void setContactDetails(DonorReceiver donorReceiver) {
        ...
        //TODO Change this once the emergancy things have been set up in the donorReceiver class
//        emergStreetAddress.setText(String.format("%s", donorReceiver.getContactDetails().getEmergAddressStreet()));
//        emergCity.setText(String.format("%s", donorReceiver.getContactDetails().getEmergAddressCity()));
//        emergRegion.setText(String.format("%s", donorReceiver.getContactDetails().getEmergAddressRegion()));
//        emergPostcode.setText(String.format("%s", donorReceiver.getContactDetails().getEmergAddressPostcode()));
//        emergMobileNumber.setText(String.format("%s", donorReceiver.getContactDetails().getEmergMobileNumber()));
//        emergHomeNumber.setText(String.format("%s", donorReceiver.getContactDetails().getEmergHomeNumber()));
//        emergEmail.setText(String.format("%s", donorReceiver.getContactDetails().getEmergEmail()));
    }
