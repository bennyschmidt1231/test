...
public class LoginController {
    ...
    @FXML public Text welcomeMessage;
    @FXML public Text loginLabel;
    @FXML public Text NHILabel;
    @FXML public TextField usernameTextField;
    @FXML public PasswordField passwordField;
    @FXML public Button loginButton;
    @FXML public Button createDonorButton;
    ...
    public void donorLogin() {
        ...
        for (DonorReceiver donorReceiver : accountManager.getDonorReceivers()) {
            if (donorReceiver.getUserName().equalsIgnoreCase(usernameTextField.getText()))
            {
                if ((donorReceiver.getPassword() != null) && (donorReceiver.getPassword().equals(passwordField.getText()))) {
    ...
    public void clinicianLogin() {
        ...
        try {
            ...
            {
                if (clinician.getUserName().equals(usernameTextField.getText())) {
                    if ((clinician.getPassword() != null) && (clinician.getPassword().equals(passwordField.getText()))) {
                        exists = true;
                        resetFields();
