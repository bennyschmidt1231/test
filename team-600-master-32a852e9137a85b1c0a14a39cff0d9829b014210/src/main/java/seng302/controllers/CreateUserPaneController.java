...
public class CreateUserPaneController {
    ...
    void createAccount(ActionEvent event) {
        ...
        for (DonorReceiver acc : db.getMasterList()) {
            if (acc.getUserName().equals(usernameTextField.getCharacters().toString())) {
        ...
        db.getDonorReceivers().add(db.reactivateOldAccountIfExists(AccountManager.getCurrentUser(), donorReceiver));
        showSuccessMessage();
