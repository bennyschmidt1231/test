...
public class App extends Application {
    ...
    private static ChildWindowManager childWindowManager = ChildWindowManager.getChildWindowManager();
    ...
    /**
     * Searches for a child window of the given type. If one exists, it is moved
     * to the front and the method returns true. Otherwise, it returns false.
     *
