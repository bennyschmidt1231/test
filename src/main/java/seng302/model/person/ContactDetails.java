...
public class ContactDetails {
  ...
  public String updateHomeNum(String value) {
    ...
    if (homeNum != null && !homeNum.equals("")) {
      message = "updated";
    } else {
      message = "updated";
    }
  ...
  public String[] updateContact(String attribute, String value) {
    ...
    switch (attribute) {
      ...
      case "addressLine1": {
        ...
        message = getAddress().updateStreetAddressLine1(value);
        break;
      }
      case "addressLine2": {
        oldVal = getAddress().getStreetAddressLn2();
        message = getAddress().updateStreetAddressLine2(value);
        break;
      }
      case "suburb": {
      ...
      case "countryCode": {
        ...
        message = getAddress().updateCountryCode(value);
        break;
      }
    }
