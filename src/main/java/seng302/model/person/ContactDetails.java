...
public class ContactDetails {
     ...
     */
    private void setMobileNum(String mobileNum) { this.mobileNum = StringExtension.nullFilter(mobileNum); }
     ...
     */
    public String getHomeNum() { return homeNum; }
     ...
     */
    private void setHomeNum(String homeNum) { this.homeNum = StringExtension.nullFilter(homeNum); }
     ...
     */
    private void setEmail(String email) { this.email = StringExtension.nullFilter(email); }
    ...
    public String updateMobileNum(String value) {
        ...
        if(mobileNum != null && !mobileNum.equals("")) { message = "updated"; }
    ...
    public String updateHomeNum(String value) {
        ...
        if(homeNum != null && !homeNum.equals("")) { message = "updated"; }
        else { message = "updated"; }
        setHomeNum(value);
        return message;
    }
    ...
    public String updateEmail(String value) {
        ...
        if (validateEmail(value)) {
            if(email != null && !email.equals("")) { message = "updated"; }
            else { message = "updated"; }
            setEmail(value);
        }
        return message;
