...
public class DonorReceiver extends User {
    ...
    public String toString() {
        ...
        if(getMiddleName() != null && !getMiddleName().equalsIgnoreCase("")) {detailsString += getMiddleName() + " ";}
        if(getLastName() != null && !getLastName().equalsIgnoreCase("")) {detailsString += getLastName();}
    ...
    public String updateAttribute(User modifyingAccount, String attribute, String value){
        ...
        switch(attribute) {
            case "height": {
                oldVal = (getUserAttributeCollection().getHeight() == null) ? "unspecified" : Double.toString(getUserAttributeCollection().getHeight());
                message = getUserAttributeCollection().updateHeight(value); break; }
            case "weight": {
                oldVal = (getUserAttributeCollection().getWeight() == null) ? "unspecified" : Double.toString(getUserAttributeCollection().getWeight());
                message = getUserAttributeCollection().updateWeight(value); break; }
            case "bloodType": {
                oldVal = (getUserAttributeCollection().getBloodType() == null) ? "unspecified" : getUserAttributeCollection().getBloodType();
                message = getUserAttributeCollection().updateBloodType(value); break; }
            case "smoker": {
                oldVal = (getUserAttributeCollection().getSmoker() == null) ? "unspecified" : Boolean.toString(getUserAttributeCollection().getSmoker());
                message = getUserAttributeCollection().updateSmoker(value); break;}
            case "bloodPressure": {
                oldVal = (getUserAttributeCollection().getBloodPressure() == null) ? "unspecified" : getUserAttributeCollection().getBloodPressure();
                message = getUserAttributeCollection().updateBloodPressure(value); break; }
            case "chronicDiseases": {
                oldVal = (getUserAttributeCollection().getChronicDiseases() == null) ? "unspecified" : getUserAttributeCollection().getChronicDiseases();
                message = getUserAttributeCollection().updateChronicDiseases(value); break; }
            case "alcoholConsumption": {
                oldVal = (getUserAttributeCollection().getAlcoholConsumption() == null) ? "unspecified" : Double.toString(getUserAttributeCollection().getAlcoholConsumption());
    ...
    /**
     * Updates the given attribute in the current instance with the given value.
     * If the message was successful, a log entry is added and a success message
