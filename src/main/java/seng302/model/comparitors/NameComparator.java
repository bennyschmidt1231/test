...
/**
 * This class is a standalone comparator designed to compare the full name of two accounts. It is
 * used for sorting tables containing DonorReceiver objects.
 */
public class NameComparator implements Comparator<DonorReceiver> {
