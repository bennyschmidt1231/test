...
//import static seng302.model.Illness;
import static seng302.controllers.ViewProfilePaneController.*;


/**
 * The controller class for the editpane. This class calls the model's issueCommand(Update) methods on whatever data fields
...
public class EditPaneController {
    ...
    public static void setAccount(DonorReceiver newDonorReceiver) {staticAccount = newDonorReceiver;}
    public static UndoableManager undoableManager = App.getUndoableManager();

    public static Boolean undoRedoChoiceBox = false;
    public static Boolean undoRedoDatePicker = false;
    public static Boolean undoRedoTextField = false;
    ...
    //Basic information
    @FXML private TextField editGivenNames;
    @FXML private Text givenNamesText;
    @FXML private TextField editLastName;
    @FXML private Text lastNameText;
    @FXML private TextField preferredName;
    @FXML private Text preferredNameText;
    @FXML private TextField editNHINumber;
    @FXML private Text nhiText;
    @FXML private DatePicker editDateOfBirth;
    @FXML private Text dateOfBirthText;
    @FXML private DatePicker editDateOfDeath;
    @FXML private Text dateOfDeathText;
    @FXML private ChoiceBox editGender;
    @FXML private Text genderText;
    @FXML private ChoiceBox birthGender;
    @FXML private Text birthGenderText;
    @FXML private ChoiceBox editTitle;
    @FXML private Text titleText;
    @FXML private TextField editHeight;
    @FXML private Text heightText;
    @FXML private TextField editWeight;
    @FXML private Text weightText;
    @FXML private ChoiceBox editBloodType;
    @FXML private Text bloodTypeText;
    @FXML private CheckBox editLivedInUKFrance;
    @FXML private Text ukFranceText;

    //Contact details
    @FXML private TextField editStreetAddress;
    @FXML private Text streetText;
    @FXML private TextField editCity;
    @FXML private Text cityText;
    @FXML private TextField editRegion;
    @FXML private Text regionText;
    @FXML private TextField editPostcode;
    @FXML private Text postcodeText;
    @FXML private TextField editMobileNumber;
    @FXML private Text mobileNumberText;
    @FXML private TextField editHomeNumber;
    @FXML private Text homeNumberText;
    @FXML private TextField editEmail;
    @FXML private Text emailText;
    @FXML private TextField editEmergStreetAddress;
    @FXML private Text emergStreetText;
    @FXML private TextField editEmergCity;
    @FXML private Text emergCityText;
    @FXML private TextField editEmergRegion;
    @FXML private Text emergRegionText;
    @FXML private TextField editEmergPostcode;
    @FXML private Text emergPostcodeText;
    @FXML private TextField editEmergMobileNumber;
    @FXML private Text emergMobileNumberText;
    @FXML private TextField editEmergHomeNumber;
    @FXML private Text emergHomeNumberText;
    @FXML private TextField editEmergEmail;
    @FXML private Text emergEmailText;
    ...
    //Organs
    @FXML private CheckBox editLiver;
    @FXML private CheckBox editKidney;
    @FXML private CheckBox editLung;
    @FXML private CheckBox editHeart;
    @FXML private CheckBox editPancreas;
    @FXML private CheckBox editIntestine;
    @FXML private CheckBox editCornea;
    @FXML private CheckBox editMiddleEar;
    @FXML private CheckBox editBone;
    @FXML private CheckBox editBoneMarrow;
    @FXML private CheckBox editSkin;
    @FXML private CheckBox editConnectiveTissue;

    //Receiving organs
    @FXML private CheckBox editReceiverLiver;
    @FXML private CheckBox editReceiverKidney;
    @FXML private CheckBox editReceiverLung;
    @FXML private CheckBox editReceiverHeart;
    @FXML private CheckBox editReceiverPancreas;
    @FXML private CheckBox editReceiverIntestine;
    @FXML private CheckBox editReceiverCornea;
    @FXML private CheckBox editReceiverMiddleEar;
    @FXML private CheckBox editReceiverBone;
    @FXML private CheckBox editReceiverBoneMarrow;
    @FXML private CheckBox editReceiverSkin;
    @FXML private CheckBox editReceiverConnectiveTissue;

    // Donating organ text
    @FXML private Text editLiverText;
    @FXML private Text editKidneyText;
    @FXML private Text editLungText;
    @FXML private Text editHeartText;
    @FXML private Text editPancreasText;
    @FXML private Text editIntestineText;
    @FXML private Text editCorneaText;
    @FXML private Text editMiddleEarText;
    @FXML private Text editBoneText;
    @FXML private Text editBoneMarrowText;
    @FXML private Text editSkinText;
    @FXML private Text editConnectiveTissueText;

    //Receiving organ text
    @FXML private Text editReceiverLiverText;
    @FXML private Text editReceiverKidneyText;
    @FXML private Text editReceiverLungText;
    @FXML private Text editReceiverHeartText;
    @FXML private Text editReceiverPancreasText;
    @FXML private Text editReceiverIntestineText;
    @FXML private Text editReceiverCorneaText;
    @FXML private Text editReceiverMiddleEarText;
    @FXML private Text editReceiverBoneText;
    @FXML private Text editReceiverBoneMarrowText;
    @FXML private Text editReceiverSkinText;
    @FXML private Text editReceiverConnectiveTissueText;

    //Medications
    @FXML private Button moveToCurrent;
    @FXML private Button moveToPrevious;
    @FXML private Button addMedication;
    @FXML private Button editMedication;
    @FXML private Button removeMedication;
    @FXML private ComboBox<String> createNewMedication;
    @FXML private ListView editCurrentMedications;
    @FXML private ListView editPreviousMedications;
    @FXML private Tab medicationsTab;

    //Medical History
    @FXML private CheckBox editSmoker;
    @FXML private Text smokerText;
    @FXML private TextField editAlcoholConsumption;
    @FXML private Text alcoholConsumptionText;
    @FXML private TextField editBloodPressure;
    @FXML private Text bloodPressureText;
    @FXML private TextField editChronicDiseases;
    @FXML private Text chronicDiseasesText;
    ...
    @FXML private TableColumn<MedicalProcedure, LocalDate> editPastProceduresDateColumn;
    @FXML private TableColumn<MedicalProcedure, String> editPastProceduresSummaryColumn;
    @FXML private TableView<MedicalProcedure> pendingProcedureTable;
    @FXML private TableColumn<MedicalProcedure, LocalDate> editPendingProceduresDateColumn;
    @FXML private TableColumn<MedicalProcedure, String> editPendingProceduresSummaryColumn;
    ...
    @FXML private Tab medicalProceduresTab;

    final ObservableList<MedicalProcedure> pastProcedures = FXCollections.observableArrayList(staticAccount.extractPastProcedures());

    final ObservableList<MedicalProcedure> pendingProcedures = FXCollections.observableArrayList(staticAccount.extractPendingProcedures());
    ...
    private void initialize() {
        ...
        //hideMedicationsEditingFromDonor(); this function is not working as expected
        if (AccountManager.getCurrentUser() instanceof DonorReceiver) { // a donor/receiver is logged in so we hide edit medical history tab
        ...
        editTitle.getSelectionModel().selectedIndexProperty().addListener(new ChangeListener<Number>() {
            @Override
        ...
        editGender.getSelectionModel().selectedIndexProperty().addListener(new ChangeListener<Number>() {
            @Override
            public void changed(ObservableValue<? extends Number> observable, Number oldValue, Number newValue) {
                if(!undoRedoChoiceBox) {
        ...
        editBloodType.getSelectionModel().selectedIndexProperty().addListener(new ChangeListener<Number>() {
            @Override
            public void changed(ObservableValue<? extends Number> observable, Number oldValue, Number newValue) {
                if(!undoRedoChoiceBox) {
        ...
        editDateOfBirth.valueProperty().addListener(new ChangeListener<LocalDate>() {
            @Override
        ...
        editDateOfDeath.valueProperty().addListener(new ChangeListener<LocalDate>() {
            @Override
            public void changed(ObservableValue<? extends LocalDate> observable, LocalDate oldValue, LocalDate newValue) {
                if(!undoRedoDatePicker) {
        ...
        handleView(); // Modify what is displayed based on whos loggen in
    }
    ...
    private void hideOrShowMedicationsTab() {
        ...
        } else if (AccountManager.getCurrentUser() instanceof Clinician || AccountManager.getCurrentUser() instanceof Administrator) {
            // clinician or admin logged in
    ...
    public void initMedications() {
        ObservableList<String> currentMedications = FXCollections.observableArrayList(donorReceiver.getMedications().getCurrentMedications());
        editCurrentMedications.setItems(currentMedications);
        ObservableList<String> previousMedications = FXCollections.observableArrayList(donorReceiver.getMedications().getPreviousMedications());
    ...
    public void saveCurrentMedication(ActionEvent event) {
        ...
        for(String medication: currentMedications) {
            if(donorReceiver.getMedications().getPreviousMedications().contains(medication)) {
                donorReceiver.getMedications().addMedicationAlphabetically(donorReceiver.getMedications().getCurrentMedications(), medication, "Previous Medication");
            } else {
                donorReceiver.getMedications().addMedicationAlphabetically(donorReceiver.getMedications().getCurrentMedications(), medication, null);
            }
        }
    }
    ...
    public void savePreviousMedication(ActionEvent event) {
        ...
        for(String medication: previousMedication) {
            if(donorReceiver.getMedications().getCurrentMedications().contains(medication)) {
                donorReceiver.getMedications().addMedicationAlphabetically(donorReceiver.getMedications().getPreviousMedications(), medication, "Current Medications");
            } else {
                donorReceiver.getMedications().addMedicationAlphabetically(donorReceiver.getMedications().getPreviousMedications(), medication, null);
            }
    ...
    public void addCurrentMedication() {
        ...
        if(!newMedication.trim().equals("") && !editCurrentMedications.getItems().contains(newMedication) && !editPreviousMedications.getItems().contains(newMedication)) {
    ...
    private void saveRemovedMedications(ActionEvent event) {
        for(String medication: medicationToDelete) {
            if(medication.startsWith("C") && donorReceiver.getMedications().getCurrentMedications().contains(medication.substring(1))) {
                donorReceiver.getMedications().removeMedication(donorReceiver.getMedications().getCurrentMedications(), medication.substring(1));
            } else if (medication.startsWith("P") && donorReceiver.getMedications().getPreviousMedications().contains(medication.substring(1))) {
                donorReceiver.getMedications().removeMedication(donorReceiver.getMedications().getPreviousMedications(), medication.substring(1));
            }
        }
    }
    ...
    private void removeCurrentPreviousMedication() {
        ObservableList<String> currentlySelectedMedications = editCurrentMedications.getSelectionModel().getSelectedItems();
        ArrayList<String> currentToRemove = new ArrayList<>(currentlySelectedMedications); //Selection doesn't work with ObservableList
        ObservableList<String> currentlySelectedPreviousMedications = editPreviousMedications.getSelectionModel().getSelectedItems();
        ArrayList<String> previousToRemove = new ArrayList<>(currentlySelectedPreviousMedications); //Selection doesn't work with ObservableList
        for(String currentlySelected: currentToRemove) {
            if(currentlySelected != null) {
                ...
                undoableManager.createMedicationRemoveChange(editCurrentMedications, currentlySelected, true, medicationToDelete);
            }
        }
        for(String previousSelected: previousToRemove) {
            if(previousSelected != null) {
                ...
                undoableManager.createMedicationRemoveChange(editPreviousMedications, previousSelected, true, medicationToDelete);
            }
        }
    ...
    private void moveCurrentToPrevious() {
        ObservableList<String> currentlySelectedMedications = editCurrentMedications.getSelectionModel().getSelectedItems();
        ArrayList<String> medicationsToMove = new ArrayList<>(currentlySelectedMedications); //Selection doesn't work with ObservableList
        for(int i = 0; i < medicationsToMove.size(); i++) {
            String currentlySelected = medicationsToMove.get(i);
            if(currentlySelected != null) {
                undoableManager.createMedicationCurrentToPreviousChange(editCurrentMedications, editPreviousMedications, currentlySelected);
                editCurrentMedications.getItems().remove(currentlySelected);
    ...
    private void movePreviousToCurrent() {
        String previousSelected = (String) editPreviousMedications.getSelectionModel().getSelectedItem();
        if(previousSelected != null) {
            undoableManager.createMedicationPreviousToCurrentChange(editCurrentMedications, editPreviousMedications, previousSelected);
            editPreviousMedications.getItems().remove(previousSelected);
    ...
    public void initCheckBoxes() {
        ...
        editSmoker.setSelected(BooleanExtension.getBoolean(donorReceiver.getUserAttributeCollection().getSmoker()));
        ...
        editReceiverConnectiveTissue.setSelected(donorReceiver.getRequiredOrgans().getConnectiveTissue());
    }
    ...
    public void initLabels() {
        ...
        if (donorOrganInventory != null && receiverOrganInventory != null) {
            ...
            if (donorOrganInventory.getConnectiveTissue() && receiverOrganInventory.getConnectiveTissue()) {
    ...
    private void initContactDetails(){
        ...
        editStreetAddress.setText(String.format("%s", donorReceiver.getContactDetails().getAddress().getStreetAddressLn1()));
        editCity.setText(String.format("%s", donorReceiver.getContactDetails().getAddress().getCityName()));
        editRegion.setText(String.format("%s", donorReceiver.getContactDetails().getAddress().getRegion()));
        ...
        editEmergStreetAddress.setText(String.format("%s", donorReceiver.getEmergencyContactDetails().getAddress().getStreetAddressLn1()));
        editEmergCity.setText(String.format("%s", donorReceiver.getEmergencyContactDetails().getAddress().getCityName()));
        editEmergRegion.setText(String.format("%s", donorReceiver.getEmergencyContactDetails().getAddress().getRegion()));
        editEmergPostcode.setText(String.format("%s", donorReceiver.getEmergencyContactDetails().getAddress().getPostCode()));
        editEmergMobileNumber.setText(String.format("%s", donorReceiver.getEmergencyContactDetails().getMobileNum()));
        editEmergHomeNumber.setText(String.format("%s", donorReceiver.getEmergencyContactDetails().getHomeNum()));
        editEmergEmail.setText(String.format("%s", donorReceiver.getEmergencyContactDetails().getEmail()));
    ...
    private void initBasicInfomation() {
        ...
        editBloodType.getSelectionModel().select(donorReceiver.getUserAttributeCollection().getBloodType());
    ...
    private void initMedicalHistory() {
        ...
        editSmoker.setSelected(BooleanExtension.getBoolean(donorReceiver.getUserAttributeCollection().getSmoker()));
        editAlcoholConsumption.setText(String.valueOf(donorReceiver.getUserAttributeCollection().getAlcoholConsumption()));
    ...
    void givenNameEntered(ActionEvent event) {
        if (!editGivenNames.getText().equals(donorReceiver.getFirstName() + " " + donorReceiver.getMiddleName())){
            String name = editGivenNames.getText();
            name = name.trim();
            if (name.indexOf(" ") != -1) {
                String otherNames = name.substring(name.indexOf(" ")+1);
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "profile", "givenName", name.substring(0,name.indexOf(" ")));
                ...
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "profile", "otherName", otherNames);
                if (showBadInputMessageIfError(donorReceiver.getUpdateMessage())) {
                    errorMessage = errorMessage + donorReceiver.getUpdateMessage();
                    givenNamesText.setFill(Color.RED);
                    editGivenNames.setStyle(" -fx-border-color: red ; -fx-border-width: 2px ; ");
                ...
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "profile", "givenName", name);
                if (showBadInputMessageIfError(donorReceiver.getUpdateMessage())) {
                    errorMessage = errorMessage + donorReceiver.getUpdateMessage();
                    givenNamesText.setFill(Color.RED);
                    editGivenNames.setStyle(" -fx-border-color: red ; -fx-border-width: 2px ; ");
    ...
    void lastNameEntered(ActionEvent event) {
        if (!editLastName.getText().equals(donorReceiver.getLastName())) {
            db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "profile", "lastName", editLastName.getText());
            if (showBadInputMessageIfError(donorReceiver.getUpdateMessage())) {
                errorMessage = errorMessage + donorReceiver.getUpdateMessage();
    ...
    void preferredNameEntered(ActionEvent event) {
        ...
        if (!preferredName.getText().equals(donorReceiver.getPreferredName())) {
            ...
            db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "profile", "preferredName", preferredName.getText());
            if (showBadInputMessageIfError(donorReceiver.getUpdateMessage())) {
                errorMessage = errorMessage + donorReceiver.getUpdateMessage();
    ...
    /**
     * Retrieves the inputted String, and updates the NHI accordingly. Currently not in use, as unsure whether NHI should be changed.
     * @param event When an event occurs in the gui.
     */
    @FXML
    void nhiEntered(ActionEvent event) {
        if (!editNHINumber.getText().equals("") && !editNHINumber.getText().equals(donorReceiver.getUserName())){
            String newNhi = editNHINumber.getText();
            db.issueCommand(AccountManager.getCurrentUser(), "update", donorReceiver.getUserName(), "profile", "NHI", newNhi);
            if (showBadInputMessageIfError(donorReceiver.getUpdateMessage())) {
                errorMessage = errorMessage + donorReceiver.getUpdateMessage();
    ...
    void dobEntered(ActionEvent event) {
        ...
        try {
            ...
            if ((date != null) && (!date.isEqual(donorReceiver.getDateOfBirth()))) {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "profile", "dateOfBirth", DonorReceiver.formatDateToString(date).replace("-", ""));
                if (showBadInputMessageIfError(donorReceiver.getUpdateMessage())) {
                    errorMessage = errorMessage + donorReceiver.getUpdateMessage();
            ...
            System.out.println("The date of birth was either empty or formatted incorrectly. Please use the format DD/MM/YYYY.");
        }
    }
    ...
    void DODEntered(ActionEvent event) {
        ...
        if (editDateOfDeath.getEditor().getText().isEmpty() && donorReceiver.getDateOfDeath() != null){
            ...
            try {
                ...
                if ((((date != null) && (donorReceiver.getDateOfDeath() != null)) && (!date.isEqual(donorReceiver.getDateOfDeath()))) ||
                        ((date != null) && (donorReceiver.getDateOfDeath() == null))) {

                    db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "profile", "dateOfDeath", DonorReceiver.formatDateToString(date).replace("-", ""));
                    if (donorReceiver.getUpdateMessage().substring(0,5).equals("ERROR")) {
                        showBadInputMessageIfError("ERROR: Invalid value " + DonorReceiver.formatDateToStringSlash(date) + ". Date of death must be a valid date that is before the " +
                ...
                System.out.println("The date of death was either empty or formatted incorrectly. Please use the format DD/MM/YYYY.");
                System.out.print(e);
            }
        }
    }
    ...
    void selectBirthGender(ActionEvent event) {
        ...
        if (donorReceiver.getBirthGender() != value.charAt(0)) {
            db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "profile", "birthGender", value);
            if (showBadInputMessageIfError(donorReceiver.getUpdateMessage())) {
                errorMessage = errorMessage + donorReceiver.getUpdateMessage();
    ...
    void heightEntered(ActionEvent event) {
        if (!editHeight.getText().equals(String.valueOf(donorReceiver.getUserAttributeCollection().getHeight()))){
            db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "attributes", "height", editHeight.getText());
            if (showBadInputMessageIfError(donorReceiver.getUpdateMessage())) {
                errorMessage = errorMessage + donorReceiver.getUpdateMessage();
    ...
    void weightEntered(ActionEvent event) {
        if (!editWeight.getText().equals(String.valueOf(donorReceiver.getUserAttributeCollection().getWeight()))) {
            db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "attributes", "weight", editWeight.getText());
            if (showBadInputMessageIfError(donorReceiver.getUpdateMessage())) {
                errorMessage = errorMessage + donorReceiver.getUpdateMessage();
    ...
    void bloodTypeSelected(ActionEvent event) {
        ...
        if (!(StringExtension.nullCompare(donorReceiver.getUserAttributeCollection().getBloodType(), blood)) && blood != null) {
            db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "attributes", "bloodType", blood);
            if (showBadInputMessageIfError(donorReceiver.getUpdateMessage())) {
                errorMessage = errorMessage + donorReceiver.getUpdateMessage();
    ...
    /**
     * Retrieves whether the checkbox is selected or not, and attempts to update the donorReceivers lived in UK/France flag
     * @param event When an event occurs in the gui.
     */
    @FXML
    void livedInUKChecked(ActionEvent event) {
        if (donorReceiver.getLivedInUKFlag() != editLivedInUKFrance.isSelected()) {
            if (editLivedInUKFrance.isSelected()) {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "profile", "livedInUKFlag", "true");
            }
            else {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "profile", "livedInUKFlag", "false");
            }
            if (showBadInputMessageIfError(donorReceiver.getUpdateMessage())) {
                errorMessage = errorMessage + donorReceiver.getUpdateMessage();
    ...
    void streetAddressEntered(ActionEvent event) {
        if (!editStreetAddress.getText().equals(donorReceiver.getContactDetails().getAddress().getStreetAddressLn1())) {
            db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "contacts", "addressStreet", editStreetAddress.getText());
            if (showBadInputMessageIfError(donorReceiver.getUpdateMessage())) {
                errorMessage = errorMessage + donorReceiver.getUpdateMessage();
    ...
    void cityEntered(ActionEvent event) {
        if (!editCity.getText().equals(donorReceiver.getContactDetails().getAddress().getCityName())) {
            db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "contacts", "addressCity", editCity.getText());
            if (showBadInputMessageIfError(donorReceiver.getUpdateMessage())) {
                errorMessage = errorMessage + donorReceiver.getUpdateMessage();
    ...
    void regionEntered(ActionEvent event) {
        if (!editRegion.getText().equals(donorReceiver.getContactDetails().getAddress().getRegion())) {
            db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "contacts", "addressRegion", editRegion.getText());
            if (showBadInputMessageIfError(donorReceiver.getUpdateMessage())) {
                errorMessage = errorMessage + donorReceiver.getUpdateMessage();
    ...
    void postCodeEntered(ActionEvent event) {
        if (!editPostcode.getText().equals(donorReceiver.getContactDetails().getAddress().getPostCode())) {
            db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "contacts", "addressPostcode", editPostcode.getText());
            if (showBadInputMessageIfError(donorReceiver.getUpdateMessage())) {
                errorMessage = errorMessage + donorReceiver.getUpdateMessage();
    ...
    void mobileNumberEntered(ActionEvent event) {
        if (!editMobileNumber.getText().equals(donorReceiver.getContactDetails().getMobileNum())) {
            db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "contacts", "mobileNumber", editMobileNumber.getText());
            if (showBadInputMessageIfError(donorReceiver.getUpdateMessage())) {
                errorMessage = errorMessage + donorReceiver.getUpdateMessage();
    ...
    void homeNumberEntered(ActionEvent event) {
        if (!editHomeNumber.getText().equals(donorReceiver.getContactDetails().getHomeNum())) {
            db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "contacts", "homeNumber", editHomeNumber.getText());
            if (showBadInputMessageIfError(donorReceiver.getUpdateMessage())) {
                errorMessage = errorMessage + donorReceiver.getUpdateMessage();
    ...
    void emailEntered(ActionEvent event) {
        if (!editEmail.getText().equals(donorReceiver.getContactDetails().getEmail())) {
            db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "contacts", "email", editEmail.getText());
            if (showBadInputMessageIfError(donorReceiver.getUpdateMessage())) {
                errorMessage = errorMessage + donorReceiver.getUpdateMessage();
    ...
    void emStreetAddressEntered(ActionEvent event) {
        if (!editEmergStreetAddress.getText().equals(donorReceiver.getEmergencyContactDetails().getAddress().getStreetAddressLn1())) {
            db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "contacts", "emergAddressStreet", editEmergStreetAddress.getText());
            if (showBadInputMessageIfError(donorReceiver.getUpdateMessage())) {
                errorMessage = errorMessage + donorReceiver.getUpdateMessage();
    ...
    void emCityEntered(ActionEvent event) {
        if (!editEmergCity.getText().equals(donorReceiver.getEmergencyContactDetails().getAddress().getCityName())) {
            db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "contacts", "emergAddressCity", editEmergCity.getText());
            if (showBadInputMessageIfError(donorReceiver.getUpdateMessage())) {
                errorMessage = errorMessage + donorReceiver.getUpdateMessage();
    ...
    void emRegionEntered(ActionEvent event) {
        if (!editEmergRegion.getText().equals(donorReceiver.getEmergencyContactDetails().getAddress().getRegion())) {
            db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "contacts", "emergAddressRegion", editEmergRegion.getText());
            if (showBadInputMessageIfError(donorReceiver.getUpdateMessage())) {
                errorMessage = errorMessage + donorReceiver.getUpdateMessage();
    ...
    void emPostCodeEntered(ActionEvent event) {
        if (!editEmergPostcode.getText().equals(donorReceiver.getEmergencyContactDetails().getAddress().getPostCode())) {
            db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "contacts", "emergAddressPostcode", editEmergPostcode.getText());
            if (showBadInputMessageIfError(donorReceiver.getUpdateMessage())) {
                errorMessage = errorMessage + donorReceiver.getUpdateMessage();
    ...
    void emMobileNumberEntered(ActionEvent event) {
        if (!editEmergMobileNumber.getText().equals(donorReceiver.getEmergencyContactDetails().getMobileNum())) {
            db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "contacts", "emergMobileNumber", editEmergMobileNumber.getText());
            if (showBadInputMessageIfError(donorReceiver.getUpdateMessage())) {
                errorMessage = errorMessage + donorReceiver.getUpdateMessage();
    ...
    void emHomeNumberEntered(ActionEvent event) {
        if (!editEmergHomeNumber.getText().equals(donorReceiver.getEmergencyContactDetails().getHomeNum())) {
            db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "contacts", "emergHomeNumber", editEmergHomeNumber.getText());
            if (showBadInputMessageIfError(donorReceiver.getUpdateMessage())) {
                errorMessage = errorMessage + donorReceiver.getUpdateMessage();
    ...
    void emEmailEntered(ActionEvent event) {
        if (!editEmergEmail.getText().equals(donorReceiver.getEmergencyContactDetails().getEmail())) {
            db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "contacts", "emergEmail", editEmergEmail.getText());
            if (showBadInputMessageIfError(donorReceiver.getUpdateMessage())) {
                errorMessage = errorMessage + donorReceiver.getUpdateMessage();
    ...
    /**
     * Checks whether the lungs checkbox is selected, and attempts to update the donorReceivers lungs value
     * @param event When an event occurs in the gui.
     */
    @FXML
    ...
    /**
     * Checks whether the liver checkbox is selected, and attempts to update the donorReceivers liver value
     * @param event When an event occurs in the gui.
     */
    @FXML
    ...
    /**
     * Checks whether the bone checkbox is selected and attempts to update the donorReceivers bone value
     * @param event When an event occurs in the gui.
     */
    @FXML
    ...
    /**
     * Checks whether the bone marrow checkbox is selected, and attempts to update the donorReceivers bone marrow value
     * @param event When an event occurs in the gui.
     */
    @FXML
    void selectedBoneMarrow(ActionEvent event) {
        if (donorReceiver.getDonorOrganInventory().getBoneMarrow() != editBoneMarrow.isSelected()) {
            if (editBoneMarrow.isSelected()) {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs", "boneMarrow", "true");
            } else {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs", "boneMarrow", "false");
            }
            showBadInputMessageIfError(donorReceiver.getUpdateMessage());
            donorReceiver.setUpdateMessage("waiting for new message");
        }
    ...
    /**
     * Checks whether the connective tissue checkbox is selected, and attempts to update the donorReceivers connective tissue value
     * @param event When an event occurs in the gui.
     */
    @FXML
    void selectedConnectiveTissue(ActionEvent event) {
        if (donorReceiver.getDonorOrganInventory().getConnectiveTissue() != editConnectiveTissue.isSelected()) {
            if (editConnectiveTissue.isSelected()) {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs", "connectiveTissue", "true");
            } else {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs", "connectiveTissue", "false");
            }
            showBadInputMessageIfError(donorReceiver.getUpdateMessage());
            donorReceiver.setUpdateMessage("waiting for new message");
        }
    ...
    /**
     * Checks whether the corneas checkbox is selected, and attempts to update the donorReceivers corneas value
     * @param event When an event occurs in the gui.
     */
    @FXML
    void selectedCorneas(ActionEvent event) {
        if (donorReceiver.getDonorOrganInventory().getCorneas() != editCornea.isSelected()) {
            if (editCornea.isSelected()) {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs", "corneas", "true");
            } else {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs", "corneas", "false");
            }
            showBadInputMessageIfError(donorReceiver.getUpdateMessage());
            donorReceiver.setUpdateMessage("waiting for new message");
        }
    ...
    /**
     * Checks whether the heart checkbox is selected, and attempts to update the donorReceivers heart value
     * @param event When an event occurs in the gui.
     */
    @FXML
    ...
    /**
     * Checks whether the intestines checkbox is selected, and attempts to update the donorReceivers intestines value
     * @param event When an event occurs in the gui.
     */
    @FXML
    void selectedIntestines(ActionEvent event) {
        if (donorReceiver.getDonorOrganInventory().getIntestine() != editIntestine.isSelected()) {
            if (editIntestine.isSelected()) {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs", "intestines", "true");
            } else {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs", "intestines", "false");
            }
            showBadInputMessageIfError(donorReceiver.getUpdateMessage());
            donorReceiver.setUpdateMessage("waiting for new message");
        }
    ...
    /**
     * Checks whether the kidney checkbox is selected, and attempts to updates the donorReceivers kidney value
     * @param event When an event occurs in the gui.
     */
    @FXML
    void selectedKidneys(ActionEvent event) {
        if (donorReceiver.getDonorOrganInventory().getKidneys() != editKidney.isSelected()) {
            if (editKidney.isSelected()) {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs", "kidneys", "true");
            } else {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs", "kidneys", "false");
            }
            showBadInputMessageIfError(donorReceiver.getUpdateMessage());
            donorReceiver.setUpdateMessage("waiting for new message");
        }
    ...
    /**
     * Checks whether the middle ears checkbox has been selected, and attempts to update the donorReceivers middle ears value
     * @param event When an event occurs in the gui.
     */
    @FXML
    void selectedMiddleEars(ActionEvent event) {
        if (donorReceiver.getDonorOrganInventory().getMiddleEars() != editMiddleEar.isSelected()) {
            if (editMiddleEar.isSelected()) {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs", "middleEars", "true");
            } else {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs", "middleEars", "false");
            }
            showBadInputMessageIfError(donorReceiver.getUpdateMessage());
            donorReceiver.setUpdateMessage("waiting for new message");
        }
    ...
    /**
     * Checks whether the pancreas checkbox is selected, and attempts to update the donorReceivers pancreas value
     * @param event When an event occurs in the gui.
     */
    @FXML
    void selectedPancreas(ActionEvent event) {
        if (donorReceiver.getDonorOrganInventory().getPancreas() != editPancreas.isSelected()) {
            if (editPancreas.isSelected()) {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs", "pancreas", "true");
            } else {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs", "pancreas", "false");
            }
            showBadInputMessageIfError(donorReceiver.getUpdateMessage());
            donorReceiver.setUpdateMessage("waiting for new message");
        }
    ...
    /**
     * Checks whether the skin checkbox is slected, and attempts to update the donorReceivers skin value
     * @param event When an event occurs in the gui.
     */
    @FXML
    ...
    void selectedLungsReceiving(ActionEvent event) {
        if (donorReceiver.getRequiredOrgans().getLungs() != editReceiverLung.isSelected()) {
            if (editReceiverLung.isSelected()) {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs","receiver", "lungs", "true");
            } else {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs", "receiver","lungs", "false");
            }
            showBadInputMessageIfError(donorReceiver.getUpdateMessage());
            donorReceiver.setUpdateMessage("waiting for new message");
        }
    ...
    void selectedLiverReceiving(ActionEvent event) {
        if (donorReceiver.getRequiredOrgans().getLiver() != editReceiverLiver.isSelected()) {
            if (editReceiverLiver.isSelected()) {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs","receiver", "liver", "true");
            } else {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs","receiver", "liver", "false");
            }
            showBadInputMessageIfError(donorReceiver.getUpdateMessage());
            donorReceiver.setUpdateMessage("waiting for new message");
        }
    ...
    void selectedBoneReceiving(ActionEvent event) {
        if (donorReceiver.getRequiredOrgans().getBone() != editReceiverBone.isSelected()) {
            if (editReceiverBone.isSelected()) {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs","receiver", "bone", "true");
            } else {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs","receiver", "bone", "false");
            }
            showBadInputMessageIfError(donorReceiver.getUpdateMessage());
            donorReceiver.setUpdateMessage("waiting for new message");
        }
    ...
    void selectedBoneMarrowReceiving(ActionEvent event) {
        if (donorReceiver.getRequiredOrgans().getBoneMarrow() != editReceiverBoneMarrow.isSelected()) {
            if (editReceiverBoneMarrow.isSelected()) {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs","receiver", "boneMarrow", "true");
            } else {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs","receiver", "boneMarrow", "false");
            }
            showBadInputMessageIfError(donorReceiver.getUpdateMessage());
            donorReceiver.setUpdateMessage("waiting for new message");
        }
    ...
    void selectedConnectiveTissueReceiving(ActionEvent event) {
        if (donorReceiver.getRequiredOrgans().getConnectiveTissue() != editReceiverConnectiveTissue.isSelected()) {
            if (editReceiverConnectiveTissue.isSelected()) {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs","receiver", "connectiveTissue", "true");
            } else {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs","receiver", "connectiveTissue", "false");
            }
            showBadInputMessageIfError(donorReceiver.getUpdateMessage());
            donorReceiver.setUpdateMessage("waiting for new message");
        }
    ...
    void selectedCorneasReceiving(ActionEvent event) {
        if (donorReceiver.getRequiredOrgans().getCorneas() != editReceiverCornea.isSelected()) {
            if (editReceiverCornea.isSelected()) {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs","receiver", "corneas", "true");
            } else {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs","receiver", "corneas", "false");
            }
            showBadInputMessageIfError(donorReceiver.getUpdateMessage());
            donorReceiver.setUpdateMessage("waiting for new message");
        }
    ...
    void selectedHeartReceiving(ActionEvent event) {
        if (donorReceiver.getRequiredOrgans().getHeart() != editReceiverHeart.isSelected()) {
            if (editReceiverHeart.isSelected()) {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs","receiver", "heart", "true");
            } else {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs","receiver", "heart", "false");
            }
            showBadInputMessageIfError(donorReceiver.getUpdateMessage());
            donorReceiver.setUpdateMessage("waiting for new message");
        }
    ...
    void selectedIntestinesReceiving(ActionEvent event) {
        if (donorReceiver.getRequiredOrgans().getIntestine() != editReceiverIntestine.isSelected()) {
            if (editReceiverIntestine.isSelected()) {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs","receiver", "intestines", "true");
            } else {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs","receiver", "intestines", "false");
            }
            showBadInputMessageIfError(donorReceiver.getUpdateMessage());
            donorReceiver.setUpdateMessage("waiting for new message");
        }
    ...
    void selectedKidneysReceiving(ActionEvent event) {
        if (donorReceiver.getRequiredOrgans().getKidneys() != editReceiverKidney.isSelected()) {
            if (editReceiverKidney.isSelected()) {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs","receiver", "kidneys", "true");
            } else {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs","receiver", "kidneys", "false");
            }
            showBadInputMessageIfError(donorReceiver.getUpdateMessage());
            donorReceiver.setUpdateMessage("waiting for new message");
        }
    ...
    void selectedMiddleEarsReceiving(ActionEvent event) {
        if (donorReceiver.getRequiredOrgans().getMiddleEars() != editReceiverMiddleEar.isSelected()) {
            if (editReceiverMiddleEar.isSelected()) {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs","receiver", "middleEars", "true");
            } else {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs","receiver", "middleEars", "false");
            }
            showBadInputMessageIfError(donorReceiver.getUpdateMessage());
            donorReceiver.setUpdateMessage("waiting for new message");
        }
    ...
    void selectedPancreasReceiving(ActionEvent event) {
        if (donorReceiver.getRequiredOrgans().getPancreas() != editReceiverPancreas.isSelected()) {
            if (editReceiverPancreas.isSelected()) {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs","receiver", "pancreas", "true");
            } else {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs","receiver", "pancreas", "false");
            }
            showBadInputMessageIfError(donorReceiver.getUpdateMessage());
            donorReceiver.setUpdateMessage("waiting for new message");
        }
    ...
    void selectedSkinReceiving(ActionEvent event) {
        if (donorReceiver.getRequiredOrgans().getSkin() != editReceiverSkin.isSelected()) {
            if (editReceiverSkin.isSelected()) {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs","receiver", "skin", "true");
            } else {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "organs","receiver", "skin", "false");
            }
            showBadInputMessageIfError(donorReceiver.getUpdateMessage());
            donorReceiver.setUpdateMessage("waiting for new message");
        }
    ...
    /**
     * Hide the medications editing tab from donors, as only clinicians
    ...
    /**
     * An alert error message dialog box which is called when there has been an error in the GUI diagnosis selection.
    ...
    /**
     * Loads the create/update Illness GUI page when the 'create diagnosis' button is pressed and sets the Illness donor
     *  attribute to the current Account being edited as well as the Illness illness attribute to the diagnosis selected
     *  in the current diagnosis table in the GUI.
     */
    void editCurrentDiagnosesButtonPressed(ActionEvent event) {
        ...
        if (current != null) {
            ...
            showSelectionErrorDialog("No current diagnosis has been selected. Please select a diagnosis to edit.");
        }
    }
     ...
     * Loads the create/update Illness GUI page when the 'create diagnosis' button is pressed and sets the Illness donor
     *  attribute to the current Account being edited as well as the Illness illness attribute to the diagnosis selected
     *  in the historic diagnosis table in the GUI.
     */
    void editHistoricDiagnosesButtonPressed(ActionEvent event) {
        ...
        if ( historic != null) {
            ...
            showSelectionErrorDialog("No historic diagnosis has been selected. Please select a diagnosis to edit.");
        }
    }
    ...
    /** A success dialog alert box given if an Illness object has been deleted. The given message is displayed in the alert.
    ...
    public void showDeletionSuccessMessage(String message) {
        ...
        alert.setContentText(String.format("%s Please save the application to make the deletion permanent.", message));
        alert.getDialogPane().setMinHeight(Region.USE_PREF_SIZE);
        alert.showAndWait();
    }
    ...
    void deleteDiagnosisButtonPressed(ActionEvent event) {
        ...
        if (historic != null && current != null) {
            ...
            showSelectionErrorDialog("No diagnosis has been selected. Please select a diagnosis to delete.");
        }
    }


    /**
     * Attempts to delete the given donor's illness diagnosis from their medical history. The user must press the 'OK'
     * button to proceed with the deletion. The user may optionally pick two diagnoses to delete. A log of the deletion
     * will be created if the deletion is carried out.
    ...
    public void callDeleteConfirmation(Illness diagnosis, Illness diagnosis2, int number) {
        ...
        try {
            if (number == 1) {
                ...
                alert.setContentText(String.format("The Diagnoses %s and %s will be deleted. Do you wish to proceed?",
                        diagnosis.getName(), diagnosis2.getName()));
            }
            Optional<ButtonType> result = alert.showAndWait();
            if (result.get() == ButtonType.OK) {
                if (number == 1) {
                    LogEntry logEntry = new LogEntry(donorReceiver, AccountManager.getCurrentUser(), "Illness '" + diagnosis.getName() + "'", "valid", "deleted");
//                    String log = donorReceiver.logIllnessStatus(diagnosis.getName(), "delete");
                    ...
                    showDeletionSuccessMessage("Diagnosis " + diagnosis.getName() + " has been successfully deleted.");
                } else {
                    LogEntry logEntry = new LogEntry(donorReceiver, AccountManager.getCurrentUser(), "Illness '" + diagnosis.getName() + "'", "valid", "deleted");
                    donorReceiver.getMasterIllnessList().remove(diagnosis);
                    donorReceiver.logChange(logEntry);
                    LogEntry logEntry2 = new LogEntry(donorReceiver, AccountManager.getCurrentUser(), "Illness '" + diagnosis2.getName() + "'", "valid", "deleted");
                    donorReceiver.getMasterIllnessList().remove(diagnosis2);
                    donorReceiver.logChange(logEntry2);
                    showDeletionSuccessMessage(String.format("Diagnoses %s and %s have been successfully deleted.", diagnosis.getName(), diagnosis2.getName()));
                }
    ...
    /**
     * Checks if the smoker checkbox is selected, and attempts to update the donorReceivers smoker value
     * @param event When an event occurs in the gui.
     */
    @FXML
    void smokerChecked(ActionEvent event) {
        ...
        if (BooleanExtension.getBoolean(donorReceiver.getUserAttributeCollection().getSmoker()) != editSmoker.isSelected()) {
            if (editSmoker.isSelected()) {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "attributes", "smoker", "true");
            }
            else {
                db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "attributes", "smoker", "false");
            }
            if (showBadInputMessageIfError(donorReceiver.getUpdateMessage())) {
                errorMessage = errorMessage + donorReceiver.getUpdateMessage();
    ...
    void alcoholEntered(ActionEvent event) {
        if (!editAlcoholConsumption.getText().equals(String.valueOf(donorReceiver.getUserAttributeCollection().getAlcoholConsumption()))) {
            db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "attributes", "alcoholConsumption", editAlcoholConsumption.getText());
            if (showBadInputMessageIfError(donorReceiver.getUpdateMessage())) {
                errorMessage = errorMessage + donorReceiver.getUpdateMessage();
    ...
    void bloodPressureEntered(ActionEvent event) {
        ...
        if (!editBloodPressure.getText().equals(donorReceiver.getUserAttributeCollection().getBloodPressure())) {
            db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "attributes", "bloodPressure", editBloodPressure.getText());
            if (showBadInputMessageIfError(donorReceiver.getUpdateMessage())) {
                errorMessage = errorMessage + donorReceiver.getUpdateMessage();
    ...
    void chronicDiseasesEntered(ActionEvent event) {
        ...
        if (!editChronicDiseases.getText().equals(donorReceiver.getUserAttributeCollection().getChronicDiseases())) {
            db.issueCommand(AccountManager.getCurrentUser(), "update", nhi, "attributes", "chronicDiseases", editChronicDiseases.getText());
            if (showBadInputMessageIfError(donorReceiver.getUpdateMessage())) {
                errorMessage = errorMessage + donorReceiver.getUpdateMessage();
            ...
            public Boolean call(TableView<MedicalProcedure> param) {
                Comparator<MedicalProcedure> comparator = new Comparator<MedicalProcedure>() {
                    public int compare(MedicalProcedure i1, MedicalProcedure i2) {
                        LocalDate date1 = i1.getDate();
                        LocalDate date2 = i2.getDate();
                        if (editPendingProceduresDateColumn.getSortType() == TableColumn.SortType.ASCENDING){
    ...
    void areYouSureDeleteProcedure(MedicalProcedure procedure) throws Exception{
        ...
        deleteConfirmation.setContentText("Are you sure you want to delete medical procedure: '" + procedure.getSummary() + "'?");
        ...
        if (result.get() == ButtonType.OK) {
            ...
            alert.setContentText("Procedure successfully deleted. Don't forget to save the application to make the change permanent.");
            alert.getDialogPane().setMinHeight(Region.USE_PREF_SIZE);
            alert.showAndWait();
        }
    }
    ...
    void pendingProcedureDeleteButtonPressed(ActionEvent event) throws Exception{
        MedicalProcedure procedureToDelete = pendingProcedureTable.getSelectionModel().getSelectedItem();
        if (procedureToDelete != null) {
            areYouSureDeleteProcedure(procedureToDelete);
        }
    }
    ...
    public void attributeHelpButtonPressed(ActionEvent event) {
        ...
        alert.setContentText(String.format("This pane gives you the ability to edit the donor's attributes. Simply" +
    ...
    public void contactHelpButtonPressed(ActionEvent event) {
        ...
        alert.setContentText(String.format("This pane gives you the ability to edit the donor's contact details. Simply" +
                " Simply edit whichever text field you wish and press 'enter' to update the database. If you have inputted invalid information " +
    ...
    public void organHelpButtonPressed(ActionEvent event) {
        ...
        alert.setContentText(String.format("This pane gives you the ability to edit the donor's organ registration. Simply" +
    ...
    public void profileHelpButtonPressed(ActionEvent event) {
        ...
        alert.setContentText(String.format("This pane gives you the ability to edit the donor's personal information. Simply" +
    ...
    public void checkAccountReceiving() {
      if(editReceiverLiver.isSelected()) {
        donorReceiver.setReceiver(true);
      }
      else if(editReceiverKidney.isSelected()) {
        donorReceiver.setReceiver(true);
      }
      else if(editReceiverHeart.isSelected()) {
        donorReceiver.setReceiver(true);
      }
      else if(editReceiverLung.isSelected()) {
        donorReceiver.setReceiver(true);
      }
      else if(editReceiverIntestine.isSelected()) {
        donorReceiver.setReceiver(true);
      }
      else if(editReceiverCornea.isSelected()) {
        donorReceiver.setReceiver(true);
      }
      else if(editReceiverMiddleEar.isSelected()) {
        donorReceiver.setReceiver(true);
      }
      else if(editReceiverSkin.isSelected()) {
        donorReceiver.setReceiver(true);
      }
      else if(editReceiverBone.isSelected()) {
        donorReceiver.setReceiver(true);
      }
      else if(editReceiverBoneMarrow.isSelected()) {
        donorReceiver.setReceiver(true);
      }
      else if(editReceiverConnectiveTissue.isSelected()) {
        donorReceiver.setReceiver(true);
      }
      else if(editReceiverPancreas.isSelected()) {
        donorReceiver.setReceiver(true);
      }
      else {
  ...
  public void handleView() {
      if (AccountManager.getCurrentUser() instanceof DonorReceiver) {    // Check that it is a donor logged in and that they're a receiver before hiding
        disableReceiver();
    ...
    public void showSuccessMessage() {
        ...
        alert.setTitle("Information Dialog");
        alert.setHeaderText("Done");
        alert.setContentText(String.format("You may have unsaved changes to this Account, remember to save to make the changes" +
                " permament if you have not already."));
        alert.getDialogPane().setMinHeight(Region.USE_PREF_SIZE);
        alert.showAndWait();
    ...
    /**
     * Converts the index of a gender combobox selection to a value which is
     * either M, F, O, or U. If the selection cannot be converted, an empty
     * String object is returned instead.
     *
     * @param index The selected gender index as a String object.
     * @return Either M, F, O, or U if the index is valid. Otherwise, an empty
     ...
     */
    public boolean showBadInputMessageIfError(String message) {
    ...
    /**
     * Provides a general warning if invalid values have been entered anywhere during editing a profile.
     */
     ...
     */
    @FXML
    public void editAll(ActionEvent event) {
        errorMessage = "";
    ...
    /**
     * Controls when the close button is pressed. Closes the window but does not save changes. Changes are lost
     */
    @FXML
    ...
    /**
     * Controls when the done button is pressed. Updates using data entered in the edit pane for the current session. Not a permanent save
    ...
    private void doneSelected(ActionEvent event) {
        ...
        if (invalidFlag) {
            ...
            handlePageSwitching();
        try {
            ListViewController.triggerRefresh();
        } catch (NullPointerException exception) {
            // Catch case where ListViewController is null because the main
    ...
    /**
     * Handles how page switching occurs, which is dependent on whether or not
    ...
    private void handlePageSwitching() {
        ...
        if (instanceIsChild) {
            ...
            PageNav.loadNewPage(PageNav.VIEW, mainTabPane.getSelectionModel().getSelectedIndex(), "profileViewTabbedPane");
        }
    }
