...
public class LoginController {
  ...
  /**
   * A boolean to store whether the donor button has been selected in the GUI, 'true' the button is
   * selected, 'false' otherwise.
   */
  private boolean donorIsSelected;

  /**
   * A boolean to store whether the clinician button has been selected in the GUI, 'true' the button
   * is selected, 'false' otherwise.
   */
  private boolean clinicianIsSelected;

  /**
   * A boolean to store whether the admin button has been selected in the GUI, 'true' the button is
   * selected, 'false' otherwise.
   */
  ...
  /**
   * Changes login GUI text fields and login conditions to only allow an admin to login when the
  ...
  /**
   * Changes login GUI text fields and login conditions to only allow a clinician to login when the
   * 'clinician' button is pressed.
   *
  ...
  /**
   * Changes login GUI text fields and login conditions to only allow a donor to login when the
   * 'donor' button is pressed.
   *
  ...
  /**
   * Checks the existence of the Staff Id, if exists, changes screen to clinician view, otherwise
   * shows error message
   */
  private void clinicianLogin() {
    String typedUsername = usernameTextField.getText().toUpperCase();
    String typedPassword = passwordField.getText();
    try {
      // Get clinician
  ...
  /**
   * Tries to log an administrator into the application, if the given values in the textfields in
   * the GUI are valid and corresponds to an existing admin. Gives an error message otherwise.
   */
