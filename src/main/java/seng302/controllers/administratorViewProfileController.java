...
public class administratorViewProfileController {
  ...
  @FXML
  TextField adminEditFirstName;
  @FXML
  TextField adminEditMiddleNames;
  @FXML
  TextField adminEditLastName;
  @FXML
  TextField adminEditUserName;
  ...
  public void doneClicked() {
    ...
    if (validGivenName && validMiddleName && validLastName && validUsername) {
      ...
      if (modifiedFirstName) {
        LogEntry firstNameLog = new LogEntry(selectedAdmin, currentUser, "firstName",
            selectedAdmin.getFirstName(), adminEditFirstName.getText());
      ...
      if (modifiedMiddleName) {
        LogEntry middleNameLog = new LogEntry(selectedAdmin, currentUser, "middleName",
            selectedAdmin.getMiddleName(), adminEditMiddleNames.getText());
      ...
      if (modifiedLastName) {
        LogEntry lastNameLog = new LogEntry(selectedAdmin, currentUser, "lastName",
            selectedAdmin.getLastName(), adminEditLastName.getText());
      ...
      if (modifiedUserName) {
        LogEntry userNameLog = new LogEntry(selectedAdmin, currentUser, "userName",
            selectedAdmin.getUserName(), adminEditUserName.getText());
  ...
  public boolean checkUsername() {
    ...
    if (!usernameIsValid) {
      ...
      boolean usernameIsUsedAdmin = (null != App.getDatabase()
          .getAdminIfItExists(adminEditUserName.getCharacters().toString()));
  ...
  private void setStyle(Boolean validUsername, Boolean validGivenName, Boolean validMiddleName,
