...
public class CreateAdministratorPaneController {
  ...
  void createAccount(ActionEvent event) {
    ...
    String middleName = givenNameTextField.getText();
    String lastName = lastNameTextField.getText();
    String username = usernameTextField.getText();
    String password = initialPasswordField.getText();

    Administrator administrator = new Administrator(givenName, middleName, lastName, username,
        password);

    db.getAdministrators().put(username, administrator);
    LogEntry logEntry = new LogEntry(administrator, admin, "created", null,
  ...
  public void showSuccessMessage() {
    ...
    alert.setContentText(String.format(
        "Administrator created. Remember to save the application to make the account permanent."));
