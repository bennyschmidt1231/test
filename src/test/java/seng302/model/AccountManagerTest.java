...
public class AccountManagerTest {
  ...
  /**
   * Checks for successful case where the update command is issued for updating a clinician's
   * givenName.
   */
  @Test
  ...
  /**
   * ignore until we can figure out how to feed input stream into the makeDecision method and stop
