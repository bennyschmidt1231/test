...
public class DonorReceiverTest {
    ...
    public void setUp() {
        ...
        contacts = new ContactDetails(new Address(null, null, null, null, null, null, null), null, null, null);
    ...
    public void toStringTest1() {
        String expected = "Donor Details:\n" +
                ...
                "Address:\n"
                + "Street Address Line 1: " + donorReceiver.getContactDetails().getAddress().getStreetAddressLn1() + "\n"
                + "Street Address Line 2: " + donorReceiver.getContactDetails().getAddress().getStreetAddressLn2() + "\n"
                ...
                + "Address:\n"
                + "Street Address Line 1: " + donorReceiver.getEmergencyContactDetails().getAddress().getStreetAddressLn1() + "\n"
                + "Street Address Line 2: " + donorReceiver.getEmergencyContactDetails().getAddress().getStreetAddressLn2() + "\n"
                ...
                + "Country Code: " + donorReceiver.getEmergencyContactDetails().getAddress().getCountryCode() + "\n"
        ...
        assertEquals(expected, donorReceiver.toString().substring(0, 124) + donorReceiver.toString().substring(143, donorReceiver.toString().length() - 1));
    }
