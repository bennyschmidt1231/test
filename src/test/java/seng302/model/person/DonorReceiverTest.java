...
public class DonorReceiverTest {
  ...
  /**
   * Tests for successful case where the updateLogToString() string matches what is expected. It is
  ...
  public void toStringTest1() {
    ...
    assertEquals(expected, donorReceiver.toString().substring(0, 124) + donorReceiver.toString()
  ...
  public void updateIllnessTest1() {
    ...
    String expectedLogString = new LogEntry(donorReceiver, admin, "Illness 'SHINGLES' chronic",
        "true", "false").toString();
