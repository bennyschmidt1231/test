...
public class RegionComparatorTest {
    ...
    public void setup() {
        ...
        donorReceiverB = new DonorReceiver("Frederick", "Aloysius", "Weld", LocalDate.of(1823, 5,9), "PNZ0006");
    ...
    /**
     * Tests regionComparator with two accounts where donorReceiverB should be before
     * donorReceiverA in an alphabetic ordering.
     */
    @Test
    public void compareTestWithAccountBBeforeAccountA() {

        // Set account regions.
        donorReceiverA.getContactDetails().setAddress(new Address( //TODO There has got to be a shorter way of doing this
        ...
        donorReceiverB.getContactDetails().setAddress(new Address( //TODO There has got to be a shorter way of doing this
