...
public class NameComparatorTest {
    ...
    public void setup() {
        ...
        donorReceiverA = new DonorReceiver("Richard", "John", "Seddon", LocalDate.of(1845,6,22), "PNZ0015");
    ...
    /**
     * Tests NameComparator with an example where donorReceiverA has a greater longest
     * common substring with the search value than donorReceiverB.
     */
    @Test
    ...
    /**
     * Tests NameComparator with an example where donorReceiverB has a greater longest
     * common substring with the search value than donorReceiverA.
     */
    @Test
    ...
    /**
     * Tests NameComparator with an example where donorReceiverA and donorReceiverB share
     * the same common substring length with the search value, but A is ordered
    ...
    /**
     * Tests NameComparator with an example where donorReceiverA and donorReceiverB share
     * the same common substring length with the search value, but B is ordered
     * first alphabetically.
     */
    @Test
    ...
    /**
     * Tests NameComparator with two equal accounts. Practically, this only
     * examines if an exception will occur.
     */
    @Test
    ...
    /**
     * Recreates list with donorReceiverB in position 0. This method is used to ensure
     * that a re-ordering does occur when donorReceiverA should be in position 0 after
     * a sort operation on list.
     */
