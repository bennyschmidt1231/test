...
public class EditPaneTest extends ApplicationTest {
    ...
    private void undoEdit(){
        ...
        donorReceiver.getEmergencyContactDetails().getAddress().updateStreetAddressLine1("31b Taylors Ave");
    ...
    public void editProfileClickDone() {
        ...
        assertEquals("23 Apple Lane", donorReceiver.getContactDetails().getAddress().getStreetAddressLn1());
        ...
        assertEquals("23 Window Lane", donorReceiver.getEmergencyContactDetails().getAddress().getStreetAddressLn1());
     ...
     */
    @Test public void editProfileClickCancel() {
        ...
        assertEquals("31b Taylors Ave", donorReceiver.getEmergencyContactDetails().getAddress().getStreetAddressLn1());
        assertEquals("Christchurch", donorReceiver.getEmergencyContactDetails().getAddress().getCityName());
