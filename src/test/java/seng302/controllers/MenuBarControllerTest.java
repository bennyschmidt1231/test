...
/**
 * MenuBarControllerTest provides a series of JUnit and TestFX tests for the class
 * MenuBarController. It also defines pre and post test behaviour.
 */
public class MenuBarControllerTest extends ApplicationTest {
  ...
  /**
   * Tests the removal of the unsaved indicator from the title of the main window after accounts
   * have been exported (and there are no more unsaved changes). The asterisk should be removed from
   * the title.
   */
  @Test
  ...
  /**
   * Tests the exportAccounts method with no unsaved indicator (an asterisk) in the window title.
   * The accounts should export successfully and no change should occur in the window title.
   */
  @Test
