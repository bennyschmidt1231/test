...
public class clinicianModificationControllerTest extends ApplicationTest {
    ...
    public void verifyInvalidInputAlertBoxesAreShown() {
        ...
        workAddressText.setText("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
        verifyBadUserInputAlertIsShown();
    ...
    public void verifyStatusBarIsUpdated() {
        ...
        Assert.assertEquals("Suiko Yagami (Clinician, Staff ID: " + STAFF_ID + ") modified.", actionLabel.getText());
